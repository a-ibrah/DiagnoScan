document.addEventListener("DOMContentLoaded", () => {
    ...
    navigate("upload-button", "/upload");
    navigate("view-button", "/view");
    ...
    if (fileInput && slideStatus && uploadBox) {
        ...
        checkButton.textContent = "Submit File";
        checkButton.style.display = "none";
        uploadBox.insertAdjacentElement("afterend", checkButton);
        ...
        fileInput.addEventListener("change", () => {
            ...
            checkButton.style.display = file ? "block" : "none";
        });
